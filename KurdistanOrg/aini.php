  ...
  <div class="row d-flex justify-content-center">
    ...
    ?>
        <div class="card p-0 col-lg-4 col-md-6  col-sm-12  anim-label-simple-fade-out">
          ...
          <?php } else { ?>
            <img class="card-img-top card-img" src="assets/images/defaultQuran.jpg" alt="Card image not provided">
          <?php } ?>
          <div class="card-body ">
            <h5 class="card-title"><?php echo  htmlspecialchars($titleTrim) ?></h5>

            <p class="card-text"><?php echo  htmlspecialchars($contDisp) . '...'; ?></p>
            <p class="card-text"><small class="text-muted"> <?php echo 'لەلایەن: ' . htmlspecialchars($post['created_by'])  ?></small></p>
      ...
      <h5 style="text-align: center;color: green" class="anim-label-simple-fade-out">ببورە! هیچ پۆستێک بەردەست نیە</h5>
    <?php } ?>
  </div>
</div>
